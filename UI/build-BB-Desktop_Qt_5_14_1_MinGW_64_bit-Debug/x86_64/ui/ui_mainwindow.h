...
""));
        ...
        runButton->setStyleSheet(QString::fromUtf8("QPushButton:hover{\n"
...
"}"));
        ...
        sizePolicy4.setHeightForWidth(addVidBtn->sizePolicy().hasHeightForWidth());
        addVidBtn->setSizePolicy(sizePolicy4);
...
"}"));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Great Eye", nullptr));
